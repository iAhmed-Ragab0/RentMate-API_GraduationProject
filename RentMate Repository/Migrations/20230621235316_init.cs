        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoOfRooms = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    NoOfBedsInTheRoom = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hasMicrowave = table.Column<bool>(type: "bit", nullable: true),
                    hasDishWasher = table.Column<bool>(type: "bit", nullable: true),
                    hasWifi = table.Column<bool>(type: "bit", nullable: true),
                    hasRefrigerator = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishingList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WishingList_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishingList_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishingList_PropertyId",
                table: "WishingList",
                column: "PropertyId");
